            ...
            if next_request is None:
                if not queue_of_requests_to_retry.empty():
                    ...
                    try:
                        ...
                        logging.debug("Processing posts exhausted")
...
if __name__ == "__main__":
    pass
    # data = []
    # with open('C:\\Users\\Eitan\\PycharmProjects\\auto-post-classifier\\output\\responses.txt', 'r') as file:
    #     for line in file:
    ...
    # result = [item['choices'][0]['message']['content'] for item in sorted_data]
    # print(result)

    # asyncio.run( process_api_requests([{
    #                                                                   "model": "gpt-3.5-turbo",
    #                                                                   "messages": [
    #                                                                       {"role": "user",
    #                                                                        "content": "say hello"}]},
    ...
    #         "messages": [
    #             {"role": "user",
    #              "content": "count from 1-10 in 3 different languages"}],
    #     "metadata": {"row_id": 1}}
    # ],
    #                                                              "somefilename.txt",
    #                                                              "OPENAI_API_KEY"))
