...
"""  # noqa: E501
    ...
    def __init__(self, responses_path: Path, api_key: str) -> None:
        self.requests = []
    ...
    def read_responses(self):
        ...
        responses_list = []
        with open(mock.RESPONSE_FILE_PATH, "r") as file:
        # with open(self.responses_path, "r") as file:
            for line in file:
                ...
                if validation:
                    ...
                    response = self.handle_bad_validation(reasone, metadata, completion_response_dict)
